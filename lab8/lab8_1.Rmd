...
penguins %>%
  group_by(species) %>%
  summarise(across(c(contains("mm"), body_mass_g), mean, na.rm = T), n_samples=n()) #the use of the c() allows you to include variables other than the ones that contain mm
```
