...
# Caracara has the largest homerange. They are highly territorial creatures and consume a variety of food such as insects, fish, reptiles, mammals, amphibians,and eggs. 
```{r}
birds <- filter(homerange, taxon=="birds")
```
```{r}
largest_home_range_species <-birds$common.name[which.max(birds$mean.hra.m2)]
```
