...
# An ordered series of data points, often of the same data class

2. What is a data matrix in R?  
# A data matrix is a series of vectors stacked upon one another in a table-like fashion
